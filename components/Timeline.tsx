...
const Timeline: React.FC<TimelineProps> = ({ currentIndex }) => {
  ...
  const items = [
    ...
    { year: 2022, title: "Project B", description: "Description of Project B", link: "https://example.com/projectB" },
  ...
  return (
    ...
    >
      {items.map((item, index) => (
        <div key={item.year} className="snap-center flex-shrink-0 w-full h-full flex items-center justify-center">
          <TimelineItem 
            {...item}
